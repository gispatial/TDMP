export default {
  pages: {
    ...
    data: [
      // DASHBOARDS
      {title: "Finance Dashboard",        url: "/pages/analytics",                icon: "DashboardIcon",           is_bookmarked: false},
      {title: "Merchant Dashboard",        url: "/pages/DashboardECommerceItemDetailView",                icon: "DashboardIcon",           is_bookmarked: false},
      {title: "Agent Dashboard",        url: "/pages/DashboardECommerce",                icon: "DashboardIcon",           is_bookmarked: false},
      {title: "Customer Dashboard",        url: "/pages/DashboardECommerce",                icon: "DashboardIcon",           is_bookmarked: false},
